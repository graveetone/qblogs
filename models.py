...
class Post(db.Model):
    ...
    def generate_slug(self):
        ...
        components = ['day', 'month', 'year', 'hour', 'minute', 'second']
        slug_date = "".join([str(getattr(current_datetime, component)) for component in components])

        if self.title:
            self.slug = slugify(f"{self.title} {slug_date}")
